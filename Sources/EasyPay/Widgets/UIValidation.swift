...
public class UIValidation {
    ...
    class func isValidZip(_ testString: String) -> Bool {
        let regex = "^[a-zA-Z0-9- ]*$"
        return NSPredicate.init(format: "SELF MATCHES %@", regex).evaluate(
            with: testString.trimmingCharacters(in: CharacterSet.whitespaces))
    }
